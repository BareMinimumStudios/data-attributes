package net.bms.data_attributes.api
 ...
 * the direct [Attribute] or the means of an [net.bms.data_attributes.api.attribute.AttributeSupplier] (or equivalent),
 * and contains manager fields and functions.
 * */
object DataAttributesAPI {
    /** The [net.bms.data_attributes.config.impl.AttributeConfigManager] that is managed on the client. */
    @JvmStatic
